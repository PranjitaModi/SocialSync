...
export default function Footer() {
    return (
        <footer style={{ background: "#f4eee1", borderTop: "1px solid rgba(124,58,237,0.08)" }}>
            <div className="max-w-6xl mx-auto px-5 sm:px-8 py-16">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-12 mb-16">
                    ...
                    <div className="lg:col-span-2">
                        <Link to="/" onClick={() => scrollTo(0, 0)} className="inline-flex items-center gap-2 mb-5">
                            ...
                            <span className="font-medium font-serif text-xl text-gray-800">SocialSync</span>
                        </Link>
                ...
                {/* Bottom bar */}
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4 pt-8" style={{ borderTop: "1px solid rgba(124,58,237,0.08)" }}>
                    <p className="text-xs text-gray-400">© {new Date().getFullYear()} SocialSync. All rights reserved.</p>
