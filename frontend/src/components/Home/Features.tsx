...
export default function Features() {
    return (
        <section id="features" className="py-24 bg-[#f4eee1]">
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="text-center mb-16">
                    ...
                    <h2 className="font-serif text-4xl sm:text-5xl font-medium leading-tight text-gray-900">
                        ...
                        <br />
                        <span className="text-violet-500 italic">social media workflow</span>
                    </h2>
                    <p className="mt-5 text-gray-500 max-w-xl mx-auto leading-relaxed">From content creation to scheduling — SocialSync handles it all so you can focus on what matters most.</p>
                </div>

                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
                    {features.map((f) => (
                        <div key={f.title} className="bg-white rounded-2xl border border-amber-100/40 p-6 hover:border-amber-200/50 hover:shadow-md hover:shadow-amber-100/30 group">
